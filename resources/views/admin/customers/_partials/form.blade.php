<div class="row">
    <div class="form-group col-4">
        <input type="text" placeholder="Nome" class="form-control" name="customer[name]" value="{{old('customer.name',$customer->name ?? '')}}" >
    </div>
    <div class="form-group col-4">
    ...
    <div class="form-group col-4">
        <input type="text" placeholder="CEP" class="form-control cep" name="address[cep]" id = "cep" value="{{old('address.cep',$customer->address->cep ?? '')}}" >
    </div>
    <div class="form-group col-4">
    ...
    <div class="form-group col-4">
        <input type="text" placeholder="UF" class="form-control uf" name="address[uf]" id = "uf" value="{{old('address.uf',$customer->address->uf ?? '')}}" >
    </div>
    <div class="form-group col-4">
